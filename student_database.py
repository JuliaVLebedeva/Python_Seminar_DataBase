...
# запись данных по ученикам в словарь. пример записи: {'Иванов':  (['Иван', '1А'], {})}
...
def save_db():
# сохр данных учеников из словаря "student_db" в файл формата .json 
    json.dump(student_db, open('db_student.json', 'w'))

def load_db():
# сохр данных учеников из файла формата .json в словарь "student_db"
    global student_db
